...
class Pager{
	...
	public function construct($totalItem,$currentPage = 1,$nItemOnPage = 9,$nPageShow = 5){
	...
	public function showPagination(){
		...
		if($this->_totalPage > 1){
			...
			$actual_link = explode('/page/', $actual_link)[0]; //ex: http://localhost:8888/shop0903/phu-kien/
			$start 	= '';
			$prev 	= '';

...
<head>
  ...
  <base href="http://localhost:8888/shop0903/">
                ...
                <div id="search">
                  <form action = "search.php" method = "GET">
                    <div class="input-group">
                      <select class="cate-dropdown hidden-xs" name="category_id" onchange="location= this.value;">
                       <option>Categories</option>
                      <?php foreach($menuArray as $m):?>
                        <option value="<?=json_decode(file_get_contents($tenMien.'selectUrlByIdCate?id_cate='.$m->id))?>"><?=$m->name?></option>
                        </a>
                        <?php endforeach?>
                      </select> 
              ...
              <div class="navleft-container">
                ...
                <div class="mega-menu-category">
                  <ul class="nav">
                    <?php foreach($menuArray as $m):?>
                    <li class="nosub">
                      <a href="<?=json_decode(file_get_contents($tenMien.'selectUrlByIdCate?id_cate='.$m->id))?>">
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-xs-12 coppyright"> Copyright © 2019 MyStore. Edit by
              <a href="facebook.com/minhyt1998"> Minh </a>. All Rights Reserved. </div>

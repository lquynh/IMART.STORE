                      ...
                      <div class="item-inner">
                          <div class="product-thumbnail">
                            ...
                            <div class="pr-img-area">
                              ...
                              <a title="<?=$p->name?>" href="<?=json_decode(file_get_contents($tenMien.'selectUrlByIdPro?id=' . $p->id))?>-<?=$p->id?>"></a>
                                <figure>
